                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><?php echo ($type); ?>修改</h3>
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal form-border" id="yfycms-form" enctype="multipart/form-data">
                                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" name="website" value="<?php echo ($vo["website"]); ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">网站名称</label>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" name="webname" value="<?php echo ($vo["webname"]); ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">名称描述</label>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" name="depict" value="<?php echo ($vo["depict"]); ?>">
                                        </div>
                                    </div>
                                   <div class="form-group">
                                        <label class="col-sm-3 control-label">网站版权</label>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" name="copyright" value="<?php echo ($vo["copyright"]); ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">网站备案号</label>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" name="number" value="<?php echo ($vo["number"]); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" name="tel" value="<?php echo ($vo["tel"]); ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">邮箱</label>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" name="email" value="<?php echo ($vo["email"]); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <?php if($vo['power'] == 1): ?><label class="radio-inline">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <button type="button" class="btn btn-primary" id="yfycms-button-submit" >更新</button>
                                        </div>
...
<script>
    var SCOPE = {
        'jump_url':'admin.php?c=website&a=index',
        'save_url':'admin.php?c=website&a=save',
    }
</script>
</body>
