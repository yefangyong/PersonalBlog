                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" name="designation"  value="<?php echo ($vo["designation"]); ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">连接地址</label>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" name="linkaddress" value="<?php echo ($vo["linkaddress"]); ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
...
<script>
    var SCOPE={
        'save_url':'admin.php?c=nav&a=add',
        'jump_url':'admin.php?c=nav',
    }
</script>
