...
<script>
    var SCOPE={
        'add_url':'admin.php?c=slide&a=add',
        'edit_url':'admin.php?c=slide&a=edit',
        'jump_url':'admin.php?c=slide',
        'set_status_url':'admin.php?c=slide&a=delete',
    }
</script>
