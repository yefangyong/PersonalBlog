...
<body>
                                    ...
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                                ...
                                                <td><img src="/guest2/Uploads/Photo/<?php echo ($vo["pic"]); ?>" style="width:100px;height:50px" alt=""></td>
                                                <td><?php echo ($vo["username"]); ?></td>
                                                <td><?php echo (date("Y-m-d H:i:s",$vo["time"])); ?></td>
                                                <td><?php echo ($vo["designation"]); ?></td>
                                                <td><?php echo ($vo["browse"]); ?></td>
                                                <td><?php if($vo['groom'] == 0): ?><span style="color:green">开启</span><?php else: ?><span style="color:red">关闭</span><?php endif; ?></td>
                                                 
                                                                          
                                                <td><?php if($vo['power'] == 0): ?><span style="color:green">开启</span><?php else: ?><span style="color:red">关闭</span><?php endif; ?></td>
                                                <td>
    ...
    <script>
        var SCOPE={
            'add_url':'admin.php?c=photo&a=add',
            'edit_url':'admin.php?c=photo&a=edit',
            'set_status_url':'admin.php?c=photo&a=delete',
