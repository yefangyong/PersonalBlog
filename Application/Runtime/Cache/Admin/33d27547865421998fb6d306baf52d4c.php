                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><?php echo ($type); ?>添加</h3>
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal form-border" action="<?php echo U(GROUP_NAME.'/Website/addxinxi');?>" method="post">
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">网站域名</label>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" name="website" placeholder="网站域名">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">网站名称</label>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" name="webname" placeholder="网站名称">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">名称描述</label>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" name="depict" placeholder="名称描述">
                                        </div>
                                    </div>
                                   <div class="form-group">
                                        <label class="col-sm-3 control-label">网站版权</label>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" name="copyright" placeholder="网站版权">
                                        </div>
                                    </div>
                                    <div class="form-group">
