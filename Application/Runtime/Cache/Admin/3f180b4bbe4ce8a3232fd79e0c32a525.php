                                    ...
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                                ...
                                                <td><?php if($vo['style'] == 0): ?>样式1<?php else: ?>样式2<?php endif; ?></td>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="javascript:void(0)" id="yfycms-delete" attr-message="删除" attr-id="<?php echo ($vo["id"]); ?>" class="btn btn-default btn-sm tooltips" data-original-title="删除" data-toggle="tooltip" data-placement="top" title="删除"><i class="fa fa-trash-o"></i></a>
                                                </td>
...
<script>
    var SCOPE={
        'add_url':'admin.php?c=axis&a=add',
        'edit_url':'admin.php?c=axis&a=edit',
        'set_status_url':'admin.php?c=axis&a=delete',
