...
<body>
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">网站关键字添加</h3>
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal form-border" id="yfycms-form" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" name="word" value="<?php echo ($list[0]['word']); ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">关键字描述</label>
                                        <div class="col-sm-6">
                                            <textarea id="editor_id" name="description"style="width:600px;height:400px;"><?php echo ($list[0]['description']); ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label"></label>
                                        <div class="col-sm-6">
                                           <input type="hidden" id="idd" name="id" value="<?php echo ($list[0]['id']); ?>">
    ...
    $(document).ready(function() {
        ...
        <script>
            var SCOPE={
                'save_url':'admin.php?c=keywords&a=save',
                'jump_url':'admin.php?c=keywords',
