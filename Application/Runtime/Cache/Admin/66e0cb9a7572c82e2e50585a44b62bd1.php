                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" name="year"  value="<?php echo ($vo["year"]); ?>">
                                        </div>
                                    </div>
...
<script>
    var SCOPE={
        'save_url':'admin.php?c=year&a=add',
        'jump_url':'admin.php?c=year',
    }
</script>
</html>