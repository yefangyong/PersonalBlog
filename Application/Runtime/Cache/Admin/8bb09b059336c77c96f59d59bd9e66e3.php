                                   ...
                                   <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <select class="form-control input-sm" name="cat_id">
                                                ...
                                                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["designation"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                            </select>
                                        </div>
                                    </div>
                                    <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vov): $mod = ($i % 2 );++$i;?><div class="form-group">
                                        <label class="col-sm-3 control-label">标题</label>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" name="title" value="<?php echo ($vov["title"]); ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" name="keyword" value="<?php echo ($vov["keyword"]); ?>">
                                        </div>
                                    </div>
                                   <div class="form-group">
                                        <label class="col-sm-3 control-label">关键词描述</label>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" name="description" value="<?php echo ($vov["description"]); ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">推荐状态</label>
                                        <div class="col-sm-6">
                                            <?php if($vov['groom'] == 1): ?><label class="radio-inline">
                                                    <input class="icheck" type="radio" name="groom" value="0">开启</label>
                                                <label class="radio-inline">
                                                    <input class="icheck" type="radio" checked="checked" name="groom" value="1">关闭</label>
                                            <?php else: ?>
                                                <label class="radio-inline">
                                                    <input class="icheck" type="radio" checked="checked" name="groom" value="0">开启</label>
                                                <label class="radio-inline">
                                                    <input class="icheck" type="radio" name="groom" value="1">关闭</label><?php endif; ?>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">开启状态</label>
                                        <div class="col-sm-6">
                                            <?php if($vov['power'] == 1): ?><label class="radio-inline">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="hidden" name="id" value="<?php echo ($vov["id"]); ?>">
...
<script>
    var SCOPE={
        ...
        'ajax_upload_image_url' : 'admin.php?c=essays&a=ajaxuploadimage',
