                                    ...
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                                ...
                                                <td><img src="/guest2/Uploads/about/<?php echo ($vo["pic"]); ?>" style="width:100px;height:50px" alt=""></td>
                                                <td><?php echo ($vo["depict"]); ?></td>
                                                <td><?php echo ($vo["ydepict"]); ?></td>
...
<script>
    var SCOPE={
        'add_url':'admin.php?c=aboutus&a=add',
        'set_status_url':'admin.php?c=aboutus&a=delete',
        'jump_url':'admin.php?c=aboutus',
        'edit_url':'admin.php?c=aboutus&a=edit',
    }
</script>
