...
<body>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">相册分类设置</h3>
                                    ...
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                                ...
                                                <td>
                                                    <a href="javascript:void(0)" attr-id="<?php echo ($vo["id"]); ?>" id="yfycms-edit" class="btn  btn-sm btn-default tooltips" data-original-title="Print" type="button" data-toggle="tooltip" data-placement="top" title="修改"><i class="fa fa-print"></i>
                                                    </a>
                                                    <a href="javascript:void(0)" attr-id="<?php echo ($vo["id"]); ?>" id="yfycms-delete" attr-message="删除" class="btn btn-default btn-sm tooltips" data-original-title="删除" data-toggle="tooltip" data-placement="top" title="删除"><i class="fa fa-trash-o"></i></a>
                                                </td>
    ...
    <script>
        var SCOPE={
            'add_url':'admin.php?c=classification&a=add',
            'set_status_url':'admin.php?c=classification&a=delete',
            'edit_url':'admin.php?c=classification&a=edit',
