...
<head>
    ...
    <link rel="shortcut icon" type="image/ico" href="/github/guest2/Public/home/images/favicon.ico">
    ...
    <!-- Vector Map  -->
    <link rel="stylesheet" href="/github/guest2/Public/admin/plugins/jvectormap/css/jquery-jvectormap-1.2.2.css">
    <!-- ToDos  -->
    <link rel="stylesheet" href="/github/guest2/Public/admin/plugins/todo/css/todos.css">
    <!-- Morris  -->
    <link rel="stylesheet" href="/github/guest2/Public/admin/plugins/morris/css/morris.css">
    <!-- Fonts -->
...
<body>
            ...
            <div class="user-nav">
                <ul>
                     ...
                     <li class="dropdown messages">
                        ...
                        <ul class="dropdown-menu alert animated fadeInDown">
                            ...
                            <li>
                                <a href="#">
                                    <div class="profile-photo">
                                        <img src="/github/guest2/Public/admin/img/avatar.gif" alt="" class="img-circle">
                                    </div>
                            ...
                            <li>
                                <a href="#">
                                    <div class="profile-photo">
                                        <img src="/github/guest2/Public/admin/img/avatar1.gif" alt="" class="img-circle">
                                    </div>
                                    <div class="message-info">
                            ...
                            <li>
                                <a href="#">
                                    <div class="profile-photo">
                                        <img src="/github/guest2/Public/admin/img/avatar2.gif" alt="" class="img-circle">
                                    </div>
                                    <div class="message-info">
                            ...
                            <li>
                                <a href="#">
                                    <div class="profile-photo">
                                        <img src="/github/guest2/Public/admin/img/avatar3.gif" alt="" class="img-circle">
                                    </div>
                                    <div class="message-info">
                            ...
                            <li>
                                <a href="#">
                                    <div class="profile-photo">
                                        <img src="/github/guest2/Public/admin/img/avatar4.gif" alt="" class="img-circle">
                                    </div>
                                    <div class="message-info">
                    ...
                    <li class="profile-photo">
                        <img src="/github/guest2/Public/admin/img/avatar.png" alt="" class="img-circle">
                    </li>
    ...
    <!--Page Level JS-->
    <script src="/github/guest2/Public/admin/plugins/countTo/jquery.countTo.js"></script>
    <script src="/github/guest2/Public/admin/plugins/weather/js/skycons.js"></script>
    <!-- FlotCharts  -->
    <script src="/github/guest2/Public/admin/plugins/flot/js/jquery.flot.min.js"></script>
    <script src="/github/guest2/Public/admin/plugins/flot/js/jquery.flot.resize.min.js"></script>
    <script src="/github/guest2/Public/admin/plugins/flot/js/jquery.flot.canvas.min.js"></script>
    <script src="/github/guest2/Public/admin/plugins/flot/js/jquery.flot.image.min.js"></script>
    <script src="/github/guest2/Public/admin/plugins/flot/js/jquery.flot.categories.min.js"></script>
    <script src="/github/guest2/Public/admin/plugins/flot/js/jquery.flot.crosshair.min.js"></script>
    <script src="/github/guest2/Public/admin/plugins/flot/js/jquery.flot.errorbars.min.js"></script>
    <script src="/github/guest2/Public/admin/plugins/flot/js/jquery.flot.fillbetween.min.js"></script>
    <script src="/github/guest2/Public/admin/plugins/flot/js/jquery.flot.navigate.min.js"></script>
    <script src="/github/guest2/Public/admin/plugins/flot/js/jquery.flot.pie.min.js"></script>
    <script src="/github/guest2/Public/admin/plugins/flot/js/jquery.flot.selection.min.js"></script>
    <script src="/github/guest2/Public/admin/plugins/flot/js/jquery.flot.stack.min.js"></script>
    <script src="/github/guest2/Public/admin/plugins/flot/js/jquery.flot.symbol.min.js"></script>
    <script src="/github/guest2/Public/admin/plugins/flot/js/jquery.flot.threshold.min.js"></script>
    <script src="/github/guest2/Public/admin/plugins/flot/js/jquery.colorhelpers.min.js"></script>
    <script src="/github/guest2/Public/admin/plugins/flot/js/jquery.flot.time.min.js"></script>
    <script src="/github/guest2/Public/admin/plugins/flot/js/jquery.flot.example.js"></script>
    <!-- Morris  -->
    <script src="/github/guest2/Public/admin/plugins/morris/js/morris.min.js"></script>
    <script src="/github/guest2/Public/admin/plugins/morris/js/raphael.2.1.0.min.js"></script>
    <!-- Vector Map  -->
    <script src="/github/guest2/Public/admin/plugins/jvectormap/js/jquery-jvectormap-1.2.2.min.js"></script>
    <script src="/github/guest2/Public/admin/plugins/jvectormap/js/jquery-jvectormap-world-mill-en.js"></script>
    <!-- ToDo List  -->
    <script src="/github/guest2/Public/admin/plugins/todo/js/todos.js"></script>
