                            ...
                            <div class="panel-body">
                                <form class="form-horizontal form-border" id="yfycms-form" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">相册分类</label>
                                        <div class="col-sm-6">
                                            <select class="form-control input-sm" name="photo_id" id="fen">
                                    ...
                                    <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$lists): $mod = ($i % 2 );++$i;?><div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <?php if($lists['groom'] == 1): ?><label class="radio-inline">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <textarea id="editor_id" name="content"style="width:800px;height:400px;"><?php echo ($lists["content"]); ?></textarea>                                        </div>
                                    </div>
                                    <div class="form-group">
...
<script>
    var SCOPE={
        'save_url':'admin.php?c=photo&a=add',
        'jump_url':'admin.php?c=photo',
        'ajax_upload_image_url' : 'admin.php?c=photo&a=ajaxuploadimage',
