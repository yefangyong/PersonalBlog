                                ...
                                <form class="form-horizontal form-border" id="yfycms-form" method="post" enctype="multipart/form-data">
                                    ...
                                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <img style="display: none" id="upload_org_code_img" src="<?php echo ($vo["pic"]); ?>" width="150" height="150">
                                   ...
                                   <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" name="ydepict" value="<?php echo ($vo["ydepict"]); ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">网名</label>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" name="names" value="<?php echo ($vo["names"]); ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">职业</label>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" name="occupation" value="<?php echo ($vo["occupation"]); ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">籍贯</label>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" name="place" value="<?php echo ($vo["place"]); ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <textarea id="editor_id" name="content"style="width:800px;height:400px;"><?php echo ($vo["content"]); ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
