                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped">
                                        <!-- <thead>
                                            <tr>
                                                <td colspan=13>
                                                    <a href="<?php echo U('Admin/Website/add');?>" class="btn btn-primary">添加+</a>
                                                </td>
                                            </tr>
                                        </thead> -->
                                        <thead>
                                        ...
                                        <tbody>
                                            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                                ...
                                                <td><?php echo ($vo["depict"]); ?></td>
                                                <td><?php echo ($vo["copyright"]); ?></td>
                                                <td><?php echo ($vo["number"]); ?></td>
                                                <td><?php echo ($vo["tel"]); ?></td>
                                                <td><?php echo ($vo["email"]); ?></td>
                                                <td><?php if($vo['power'] == 0): ?>开启<?php else: ?>关闭<?php endif; ?></td>
                                                <td>
                                                    <a href="<?php echo U(Admin.'/Website/edit',array('id'=>$vo['id']));?>" class="btn  btn-sm btn-default tooltips" data-original-title="Print" type="button" data-toggle="tooltip" data-placement="top" title="修改"><i class="fa fa-print"></i>
                                                    </a>
                                                   <!--  <a href="<?php echo U('Admin/Website/delete',array('id'=>$vo['id']));?>" class="btn btn-default btn-sm tooltips" data-original-title="删除" data-toggle="tooltip" data-placement="top" title="删除"><i class="fa fa-trash-o"></i></a> -->
                                                </td>
