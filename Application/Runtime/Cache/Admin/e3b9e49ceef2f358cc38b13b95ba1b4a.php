                            ...
                            <div class="panel-body">
                                <form class="form-horizontal form-border" id="yfycms-form" enctype="multipart/form-data">
                                   ...
                                   <div class="form-group">
                                    ...
                                    <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vv): $mod = ($i % 2 );++$i;?><div class="form-group">
                                        <label class="col-sm-3 control-label">标题</label>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" name="title" value="<?php echo ($vv["title"]); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <?php if($vv['power'] == 1): ?><label class="radio-inline">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <?php if($vv['style'] == 1): ?><label class="radio-inline">
                                            ...
                                            <?php else: ?>
                                                <label class="radio-inline">
                                                    <input class="icheck" type="radio" checked="checked" name="style" value="0">样式1</label>
                                                <label class="radio-inline">
                                                    <input class="icheck" type="radio" name="style" value="1">样式2</label><?php endif; ?>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">详情</label>
                                        <div class="col-sm-6">
                                            <textarea id="editor_id" name="content"style="width:600px;height:400px;"><?php echo ($vv["content"]); ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
