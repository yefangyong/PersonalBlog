            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">LOGO修改</h3>
                    ...
                    <div class="panel-body">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <button type="button" class="btn btn-primary" id="yfycms-button-submit">提交</button>
                                </div>
...
<script>
    var SCOPE={
        'save_url':'admin.php?c=logo&a=save',
        'jump_url':'admin.php?c=logo',
        'ajax_upload_image_url' : 'admin.php?c=logo&a=ajaxuploadimage',
