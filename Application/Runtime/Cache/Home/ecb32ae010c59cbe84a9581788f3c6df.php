...
<div class="ibody">
  ...
  <article>
    <h2 class="about_h">您现在的位置是：<a href="<?php echo ($web[0]['website']); ?>">首页</a>><a href="<?php echo U(Home.'/Photo/more',array('id'=>$classification[0]['id']));?>"><?php echo ($classification[0]['designation']); ?></a>><a href=""><?php echo ($arr[0]['title']); ?></a></h2>
    <div class="index_about">
      <h2 class="c_titile"><?php echo ($arr[0]['title']); ?></h2>
      <p class="box_c"><span class="d_time">发布时间：<?php echo (date("Y-m-d",$arr[0]['time'])); ?></span><span>编辑：<?php echo ($arr[0]['zuozhe']); ?></span><span>浏览（<?php echo ($arr[0]['browse']); ?>）</span></p>
      <ul class="infos">
